import type { Player, GameResult } from '@/server/types';
...
export type IndividualSettlement = {
  fromPlayerId: string;
...
export const calculateGamePayments = (
  results: GameResult[],
  _players: Player[]
): PaymentRecord[] => {
...
export const calculateIndividualSettlements = (
  allGamesResults: GameResult[][],
  players: Player[]
